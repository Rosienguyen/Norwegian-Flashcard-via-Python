...
known_button = Button(image=no_image, command = flip_card_again)
known_button.grid(row=1, column=1, sticky="E")

no_image = PhotoImage(file='./images/USA_resized.png')
flip_button = Button(image = no_image, text = 'flip', command = flip_card)
